    ...
    <div className = {styles.content}>
      <div className = {styles.m2}>
        {record.content ? (
          ...
          <span>
            You do not have a profile record attached to your 3ID. Create a basic profile ny setting a namme below.
          </span>
        )}
      </div>
      <input
    ...
    <div className={styles.main}>
      <div className = {styles.navbar}>
        ...
        {connection.status == "connected" ? (
          ...
          <button onClick = {connectToSelfID}
          className = {styles.button}
          disables = {connection.status == "connecting"}
          > Connect </button>
        )}
      </div>
      <div className = {styles.content}>
